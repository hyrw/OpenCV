...
/// 透视变换, 4区域
/// </summary>
public class CoordinateTransformationV4 : ICoordinateTransformation
{
    ...
    public CoordinateTransformationV4(IList<Point> from, IList<Point> to, int width, int height)
    {
        this.width = width;
        this.height = height;
