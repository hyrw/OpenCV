...
Mat TestRegionFillHorizontal(Mat mat)
{
...
Mat TestRegionFillVertical(Mat mat)
{
...
Mat TestRegionFillHorizontalSnake(Mat mat)
{
    int fillStep = 5;
...
Mat TestRegionFillVerticalSnake(Mat mat)
{
    int fillStep = 5;
...
Mat TestRegionFillOutsideRing(Mat mat, int fillStep)
{
...
Mat TestRegionFillInsideRing(Mat mat, int fillStep)
{
    Scalar red = Scalar.Red;
    Scalar green = Scalar.Green;
