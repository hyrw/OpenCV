...
{
    public static (Scalar lower, Scalar upper) GetHRange(this Scalar self, int threshold = 20)
    {
        ...
        var mat = new Mat(new Size(1, 1), MatType.CV_8UC3, self);
        var color = mat.CvtColor(ColorConversionCodes.BGR2HSV);
